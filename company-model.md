...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Qubiz") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/emtreila/qubiz-systems-international-srl-nodejs-scraper/master/.github/workflows/scrape.yml`)
